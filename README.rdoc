...
RTLize is a Rails plugin that semi-automatically allows you to use the same css sources to produce both left-to-right and right-to-left stylesheets for your markup. It does this by intelligently switching all the left/right properties and values in the stylesheets you choose to RTLize.
...
Now you'll need to make symbolic links (or copies if you must) of your stylesheets with the '.css' extension replaced with '.rtl.css'.
